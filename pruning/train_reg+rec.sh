...
CUDA_VISIBLE_DEVICES=$1 python  -m torch.distributed.launch --nproc_per_node=$2  --master_port=$3  \
	train_reg+rec.py ${CIFAR100_PATH}/ --dataset torch/cifar100 --num-classes 100 --model vit_base_patch16_224_in21k  \
	...
	--reg 1e-4  \
    --rec 0.75   \
    --model-path /data/hjy/SSF/baseline-ssf-93.88.pth.tar   

...
CUDA_VISIBLE_DEVICES=$1 python  -m torch.distributed.launch --nproc_per_node=2  --master_port=$2  \
	train.py ${VTAB_PATH}/dmlab  --dataset dmlab --num-classes 6  --no-aug  --direct-resize  --model vit_base_patch16_224_in21k  \
	...
	--output  ${OUTPUT_PATH}/vit_base_patch16_224_in21k/vtab/dmlab/linear_probe \

...
CUDA_VISIBLE_DEVICES=$1 python -m torch.distributed.launch --nproc_per_node=1  --master_port=$2  \
	pruning/retrain_full.py ${VTAB_PATH}/caltech101 --dataset caltech101 --num-classes 102 --model vit_base_patch16_224_in21k  \
	...
	--reg 1e-4\
    --model-path /data/hjy/SSF/ckpts/vtab/caltech101-checkpoint-40.pth.tar \
    # --lora-rank $4

...
export DATASET="pets"
export MODEL_PATH="/data/hjy/SSF/ckpts/vtab/pruned/pets-79.10.pth.tar"

CUDA_VISIBLE_DEVICES=$1 python -m torch.distributed.launch --nproc_per_node=1  --master_port=$2  \
	pruning/retrain_full.py ${VTAB_PATH}/oxford_iiit_pet --dataset ${DATASET} --num-classes 37 --no-aug --direct-resize --model vit_base_patch16_224_in21k  \

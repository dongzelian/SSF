...
CUDA_VISIBLE_DEVICES=$1 python  -m torch.distributed.launch --nproc_per_node=1  --master_port=$2  \
	pruning/train_reg+rec.py ${VTAB_PATH}/oxford_iiit_pet  --dataset pets --num-classes 37 --model vit_base_patch16_224_in21k  \
	...
	--reg 1e-2  \
    --rec 0.5  \
    --model-path /data/hjy/SSF/vit_base_patch16_224_in21k/vtab/pets/baeline-91.96-155.pth.tar
